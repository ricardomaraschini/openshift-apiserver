...
func autoConvert_v1_ImageTag_To_image_ImageTag(in *v1.ImageTag, out *image.ImageTag, s conversion.Scope) error {
	...
	if in.Status != nil {
		...
		*out = new(image.NamedTagEventList)
		if err := Convert_v1_NamedTagEventList_To_image_NamedTagEventList(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Status = nil
...
func autoConvert_image_ImageTag_To_v1_ImageTag(in *image.ImageTag, out *v1.ImageTag, s conversion.Scope) error {
	...
	if in.Status != nil {
		in, out := &in.Status, &out.Status
		*out = new(v1.NamedTagEventList)
		if err := Convert_image_NamedTagEventList_To_v1_NamedTagEventList(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Status = nil
...
func autoConvert_v1_NamedTagEventList_To_image_NamedTagEventList(in *v1.NamedTagEventList, out *image.NamedTagEventList, s conversion.Scope) error {
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]image.TagEvent, len(*in))
		for i := range *in {
			if err := Convert_v1_TagEvent_To_image_TagEvent(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_image_NamedTagEventList_To_v1_NamedTagEventList(in *image.NamedTagEventList, out *v1.NamedTagEventList, s conversion.Scope) error {
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]v1.TagEvent, len(*in))
		for i := range *in {
			if err := Convert_image_TagEvent_To_v1_TagEvent(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
