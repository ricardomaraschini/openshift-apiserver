...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.ImageManifest)(nil), (*image.ImageManifest)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ImageManifest_To_image_ImageManifest(a.(*v1.ImageManifest), b.(*image.ImageManifest), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*image.ImageManifest)(nil), (*v1.ImageManifest)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_image_ImageManifest_To_v1_ImageManifest(a.(*image.ImageManifest), b.(*v1.ImageManifest), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*v1.ManifestPlatform)(nil), (*image.ManifestPlatform)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ManifestPlatform_To_image_ManifestPlatform(a.(*v1.ManifestPlatform), b.(*image.ManifestPlatform), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*image.ManifestPlatform)(nil), (*v1.ManifestPlatform)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_image_ManifestPlatform_To_v1_ManifestPlatform(a.(*image.ManifestPlatform), b.(*v1.ManifestPlatform), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_Image_To_image_Image(in *v1.Image, out *image.Image, s conversion.Scope) error {
	...
	out.DockerImageManifests = *(*[]image.ImageManifest)(unsafe.Pointer(&in.DockerImageManifests))
	return nil
}
...
func autoConvert_image_Image_To_v1_Image(in *image.Image, out *v1.Image, s conversion.Scope) error {
	...
	out.DockerImageManifestMediaType = in.DockerImageManifestMediaType
	out.DockerImageConfig = in.DockerImageConfig
	out.DockerImageManifests = *(*[]v1.ImageManifest)(unsafe.Pointer(&in.DockerImageManifests))
	return nil
}
...
func autoConvert_v1_ImageManifest_To_image_ImageManifest(in *v1.ImageManifest, out *image.ImageManifest, s conversion.Scope) error {
	out.Digest = in.Digest
	out.MediaType = in.MediaType
	if err := Convert_v1_ManifestPlatform_To_image_ManifestPlatform(&in.Platform, &out.Platform, s); err != nil {
		return err
	}
	out.ManifestSize = in.ManifestSize
	return nil
}

// Convert_v1_ImageManifest_To_image_ImageManifest is an autogenerated conversion function.
func Convert_v1_ImageManifest_To_image_ImageManifest(in *v1.ImageManifest, out *image.ImageManifest, s conversion.Scope) error {
	return autoConvert_v1_ImageManifest_To_image_ImageManifest(in, out, s)
}

func autoConvert_image_ImageManifest_To_v1_ImageManifest(in *image.ImageManifest, out *v1.ImageManifest, s conversion.Scope) error {
	out.Digest = in.Digest
	out.MediaType = in.MediaType
	if err := Convert_image_ManifestPlatform_To_v1_ManifestPlatform(&in.Platform, &out.Platform, s); err != nil {
		return err
	}
	out.ManifestSize = in.ManifestSize
	return nil
...
// Convert_image_ImageManifest_To_v1_ImageManifest is an autogenerated conversion function.
func Convert_image_ImageManifest_To_v1_ImageManifest(in *image.ImageManifest, out *v1.ImageManifest, s conversion.Scope) error {
	return autoConvert_image_ImageManifest_To_v1_ImageManifest(in, out, s)
}
...
func autoConvert_v1_ManifestPlatform_To_image_ManifestPlatform(in *v1.ManifestPlatform, out *image.ManifestPlatform, s conversion.Scope) error {
...
// Convert_v1_ManifestPlatform_To_image_ManifestPlatform is an autogenerated conversion function.
func Convert_v1_ManifestPlatform_To_image_ManifestPlatform(in *v1.ManifestPlatform, out *image.ManifestPlatform, s conversion.Scope) error {
	return autoConvert_v1_ManifestPlatform_To_image_ManifestPlatform(in, out, s)
}

func autoConvert_image_ManifestPlatform_To_v1_ManifestPlatform(in *image.ManifestPlatform, out *v1.ManifestPlatform, s conversion.Scope) error {
	out.Architecture = in.Architecture
	out.OS = in.OS
	out.Variant = in.Variant
	return nil
...
// Convert_image_ManifestPlatform_To_v1_ManifestPlatform is an autogenerated conversion function.
func Convert_image_ManifestPlatform_To_v1_ManifestPlatform(in *image.ManifestPlatform, out *v1.ManifestPlatform, s conversion.Scope) error {
	return autoConvert_image_ManifestPlatform_To_v1_ManifestPlatform(in, out, s)
}
