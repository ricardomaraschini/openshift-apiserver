...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManifestPlatform) DeepCopyInto(out *ManifestPlatform) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManifestPlatform.
func (in *ManifestPlatform) DeepCopy() *ManifestPlatform {
	if in == nil {
		return nil
	}
	out := new(ManifestPlatform)
	in.DeepCopyInto(out)
	return out
}
