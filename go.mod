...
replace (
	...
	github.com/openshift/api => github.com/ricardomaraschini/api v0.0.0-20210202090018-a7437ffe6d44
	...
	k8s.io/apiserver => github.com/openshift/kubernetes-apiserver v0.0.0-20210106144646-d2bf56fab5ef
